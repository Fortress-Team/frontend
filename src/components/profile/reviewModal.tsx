...
return (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm my-5">
      ...
      {!loading && review && (
        <div className="mt-4 space-y-4 text-gray-800">
          ...
          <p>
            ...
            {review.strengths.length ? review.strengths.join(', ') : 'No strengths listed.'}
          </p>
          <p>
            <strong>Missing/Weak Areas:</strong>{' '}
            {review.missing.length ? review.missing.join(', ') : 'No weak areas noted.'}
          </p>
          <p>
