...
import type {  Project,  UserLinks } from '../../lib/api'
...
const MocksEditProfile = () => {
    ...
    const [isSubmitting, setIsSubmitting] = useState<{ type:  'project' | 'education' | null }>({ type: null })
...
export default MocksEditProfile
